...
<div class="class-body>
  <ul class="list-group">
    ...
    <p class="list-group-item list-group-item-action list-group-item-light"><span>Email:<a href="mailto:${data.email}"> ${data.email}</a></span></p>
...
<div class="class-body>
  <ul class="list-group">
    <p class="list-group-item list-group-item-action list-group-item-light"><span>ID: ${data.id}</span> </p>
    <p class="list-group-item list-group-item-action list-group-item-light"><span>Email:<a href="mailto:${data.email}"> ${data.email}</a></span></p>
    <p class="list-group-item list-group-item-action list-group-item-light"><span>Github:<a href="${data.getGithub()}"> ${data.getGithub()}</a></span></p>
  </ul>
</div>
</div>
</div>`
